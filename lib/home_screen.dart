...
class _HomePageState extends State<HomePage> {
  ...
  void initialOperationofDataLoading() {
        ...
        Container(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return cardforCategoryList(index);
            },
          ),
        )
      ],
          ...
          children: [
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return cardforRecommendationDietList(index, context);
                },
              ),
            ),
          ],
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: cardforPopularDietsList(),
                  );
                },
              ),
            ),
          )
          // cardforPopularDietsList()
        ],
      ),
    );
  }
  ...
  Container cardforCategoryList(int index) {
    return Container(
      width: 100,
      decoration: BoxDecoration(
  ...
  Container cardforRecommendationDietList(int index, BuildContext context) {
    return Container(
      width: 240,
      decoration: BoxDecoration(
